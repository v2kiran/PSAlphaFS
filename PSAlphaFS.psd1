...
@{
    ...
    FunctionsToExport = 
    @(
        'Copy-LongItem','DisMount-LongShare','Get-LongChildItem','Get-LongDirectorySize',
        'Get-LongDiskDrive','Get-LongFreeDriveLetter','Get-LongItem','Get-LongMappedDrive',
        'Mount-LongShare','Move-LongItem','New-LongItem','Remove-LongItem','Rename-LongItem'
    )
